  ...
  return (
    <>
      <section className="container mx-auto" id="reviews-cases">
        ...
        <div className="grid gap-4 overflow-x-auto sm:grid-cols-4 grid-flow-col auto-cols-[minmax(90%,_1fr)] md:auto-cols-auto md:grid-flow-row md:overflow-x-visible md:grid-cols-1 md:grid-cols-12 snap-x snap-mandatory scroll-smooth p-6">
